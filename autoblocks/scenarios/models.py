"""Scenarios interface for managing conversation scenarios."""

from autoblocks._impl.scenarios.models import GenerateMessageRequest
...
from autoblocks._impl.scenarios.models import MessageRole
