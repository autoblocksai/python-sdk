...
class PromptRegistry:
    ...
    @classmethod
    def register_prompt(cls, app_normalized_name: str, prompt_id: str, 
                        factory_func: Callable, major_versions: List[str]) -> None:
        """
